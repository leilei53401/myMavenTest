...
//         sockIOPool.setServers(new String[]{"127.0.0.1:11211"});//设置memcached服务器地址
         sockIOPool.setServers(new String[]{"60.29.252.77:16688"});//设置memcached服务器地址
  ...
  public static boolean set(String key, Object value, Date expire) {
   ...
   public static long incr(String key) {
	    try {
	      long value = memCachedClient.incr(key);
	      System.out.println("value is "+value);
	      return value;
	    } catch (Exception e) {
	      MemcachedLogUtils.writeLog("Memcached incr方法报错，key值：" + key + "\r\n" + exceptionWrite(e));
	      return -1;
	    }
	}
