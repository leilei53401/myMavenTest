...
public class ShardedJedisTest {
	...
	private String ip = "172.16.42.20";
	private String ip2 = "172.16.42.21";
...
//		config.setMaxWait(1000l);
		...
		shards.add(new JedisShardInfo(ip2, 6379, "slave"));
		// 构造池
...
/*		// key检测
	...
	private void testIncr() {
		...
		long v = shardedJedis.incr("incr");
		System.out.println("incr v = "+v);
		 shardedJedis.incr("incr");
		 shardedJedis.incr("incr");
		 shardedJedis.incr("incr");
		 v = shardedJedis.incr("incr");
		System.out.println("incr v2 = "+v);
